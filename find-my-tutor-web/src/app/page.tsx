          ...
          <div className="w-[636px] flex flex-col">
            ...
            <div className="flex flex-col gap-[52px] mt-[58px] ">
              <div className="flex flex-row gap-[27px]">
                <div className="text-[38px] text-[#53B751]"><FaCheckSquare /></div>
                <div className="text-[20px] leading-[25px]">ccusamus sit nihil, adipisci ex quod </div>
              </div>
              <div className="flex flex-row gap-[27px]">
                <div className="text-[38px] text-[#CB6288]"><FaCheckSquare /></div>
                <div className="text-[20px] leading-[25px]">ccusamus sit nihil, adipisci ex quod </div>
              </div>
              <div className="flex flex-row gap-[27px]">
                <div className="text-[38px] text-[#3A61EB]"><FaCheckSquare /></div>
                <div className="text-[20px] leading-[25px]">ccusamus sit nihil, adipisci ex quod </div>
              </div>
            </div>
