...
>>>>>>> c4817488c7e3f9d92d3ab2b46c4c33422cb5a9ec
              </div>
          ...
          <div className="flex flex-row xl:gap-[12vw] lg:gap-[5vw] gap-10 z-10 justify-center mt-[200px]">
            <Image src={"/pictures/student_laptop.png"} width={382} height={470} alt="student" className="mt-[42px] max-w-[382px] max-h-[470px]" />
            <div className="w-[44.1vw] flex flex-col">
              ...
              <div className="flex flex-col gap-[52px] mt-[58px] ">
                <div className="flex flex-row lg:gap-[27px] gap-[18px]">
                  <div className="lg:text-[38px] text-[30px] text-[#53B751]"><FaCheckSquare /></div>
                  <div className="lg:text-[20px] text-[16px] lg:leading-[25px] leading-[20px]">ccusamus sit nihil, adipisci ex quod </div>
                </div>
                <div className="flex flex-row lg:gap-[27px] gap-[18px]">
                  <div className="lg:text-[38px] text-[30px] text-[#CB6288]"><FaCheckSquare /></div>
                  <div className="lg:text-[20px] text-[16px] lg:leading-[25px] leading-[20px]">ccusamus sit nihil, adipisci ex quod </div>
                </div>
                <div className="flex flex-row lg:gap-[27px] gap-[18px]">
                  <div className="lg:text-[38px] text-[30px] text-[#3A61EB]"><FaCheckSquare /></div>
                  <div className="lg:text-[20px] text-[16px] lg:leading-[25px] leading-[20px]">ccusamus sit nihil, adipisci ex quod </div>
                </div>
              </div>
              <div className="w-[242px] h-[68px] text-[20px] leading-[25px] font-semibold  rounded-full text-white flex items-center justify-center bg-[#FF3429] hover:bg-[#E92016] cursor-pointer mt-[72px]">Know more</div>
            </div>
          </div>
...
<<<<<<< HEAD
          <div className="container mx-auto px-4 mt-[123px] flex flex-col items-center">
            ...
            <div className="flex lg:flex-row flex-col gap-[25px] mt-[7.1vw]">
              ...
              <div className="flex flex-row gap-[24px] bg-[#80838212] rounded-[12px] w-[330px] h-[94px] justify-center items-center">
                <div className="text-[#FF3429] text-[44px]"><IoMdHelpCircleOutline /></div>
                <div className="text-[24px] leading-[30px]">
...
<<<<<<< HEAD
          <div className="pt-[10vw] lg:pt-[21vw] pl-[8.4vw] pr-[4.2vw]">
            <div className="flex flex-col gap-5 pb-[81px]">
              <div className="text-[48px] leading-[60px] font-bold text-[#162764]">Meet The Team Member</div>
...
>>>>>>> c4817488c7e3f9d92d3ab2b46c4c33422cb5a9ec
            ...
            <div className="flex flex-row gap-[100px] mb-[244px] overflow-x-scroll x-scrollbar">
              <div className="min-w-[353px] h-[448px] rounded-[12px] shadow-[0_4px_17px_#00000025]">
                ...
                <div className="h-auto flex flex-col items-center pt-5 pb-10">
                  ...
                  <div className="text-[#FF3429] text-[20px] leading-[40px] font-semibold mb-5">Co - Founder</div>
          ...
          <div className="pl-[8.4vw] ">
            <div className="w-[334px] h-[41px] flex justify-center items-center bg-[#FF342910] text-[#FF3429] rounded-md text-[24px] font-semibold">SOCIAL REACTION</div>
            <div className="w-auto pr-[4.2vw] flex flex-row justify-between pt-[45px]">
              <div className="text-[48px] leading-[60px] font-bold text-[#162764]">Social Quotes From Our User</div>
              <div className="w-[116px] flex flex-row justify-between text-[46px] text-[#FF3429]">
                <IoIosArrowDropleft />
                <IoIosArrowDroprightCircle />
              </div>
