...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-screen h-screen overflow-hidden relative">
      ...
      {/* Login Box */}
      <div className="pl-32 flex flex-col items-start justify-center h-4/6 w-4/6 bg-gray-100 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 shadow-[rgba(5,_183,_186,_0.4)_0px_0px_18px] rounded-lg p-8">
        <div className="flex flex-row items-center justify-between space-x-12 h-32 ml-10">
          <div className="flex flex-col justify-center items-center">
            <a
              className={`${
                selectedUserType == 0 ? "text-baseColor-600" : "text-slate-300"
              } ${
                selectedUserType == 1
          ...
          <div className="flex flex-col justify-center items-center">
            <a
              className={`${
                selectedUserType == 1 ? "text-baseColor-600" : "text-slate-300"
              } ${
                selectedUserType == 0
                  ? "hover:text-baseColor-400"
                  : "hover:text-baseColor-600"
